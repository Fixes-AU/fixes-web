...
export const metadata: Metadata = {
  title: 'Fixes Help Centre | Client & Tradie Support',
        ...
        <div className="max-w-200 mx-auto text-center">
          <div className="bg-[#f6f6f6] rounded-2xl p-12 lg:p-20 border border-gray-100">
            ...
            <p className="text-[0.95rem] text-(--upwork-gray) leading-relaxed max-w-125 mx-auto mb-8">
              Whether you're a client needing help with a completed job, a payment concern, or a tradie with a question about a payout, our team is ready to assist.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a href="/dashboard/support" className="inline-flex items-center justify-center px-8 py-4 font-bold text-(--upwork-navy) transition-colors hover:opacity-90 rounded-full bg-[#A4FF43]">
                Open Support Case
              </a>
              <a href="mailto:contact@fixesau.com?subject=Fixes%20Help%20%26%20Support%20Request" className="inline-flex items-center justify-center px-8 py-4 font-bold text-(--upwork-navy) transition-colors hover:bg-gray-100 rounded-full bg-white border border-gray-200">
                Email Support
              </a>
            </div>
            <p className="text-xs text-(--upwork-gray) leading-relaxed max-w-125 mx-auto mt-5">
              For completed job concerns, include the job code, what happened, and any photos or chat details. Support will review the case before any dispute or payment action is opened.
            </p>
          </div>
        </div>
      </section>
