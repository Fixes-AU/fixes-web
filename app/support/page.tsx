      ...
      <section className="py-16 lg:py-24 px-4 lg:px-6 grow">
        <div className="max-w-200 mx-auto text-center">
          <div className="bg-[#f6f6f6] rounded-2xl p-12 lg:p-20 border border-gray-100">
            ...
            <a href="mailto:contact@fixesau.com?subject=Fixes%20Help%20%26%20Support%20Request" className="inline-flex items-center justify-center px-8 py-4 font-bold text-(--upwork-navy) transition-colors hover:opacity-90 rounded-full bg-[#A4FF43]">
