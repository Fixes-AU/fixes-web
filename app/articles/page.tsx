...
export const metadata: Metadata = {
  title: 'Articles for Clients | Fixes — Hire Trusted Tradies Instantly',
  description: 'Read the latest articles, guides, and tips for homeowners and clients on the Fixes platform.',
}
      ...
      <section className="bg-(--upwork-navy) text-white py-16 lg:py-24 px-4 lg:px-6">
        <div className="max-w-275 mx-auto text-center">
          ...
          <p className="text-base text-white/70 leading-relaxed max-w-150 mx-auto">
            Discover tips for home maintenance, hiring the right tradie, and getting the most out of the Fixes platform.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-275 mx-auto text-center">
          <div className="bg-[#f6f6f6] rounded-2xl p-12 lg:p-20 border border-gray-100">
            ...
            <p className="text-[0.95rem] text-(--upwork-gray) leading-relaxed max-w-125 mx-auto">
              We are currently curating a collection of high-quality articles and guides for homeowners. Check back soon for expert advice on all things home improvement and maintenance.
            </p>
          </div>
        </div>
      </section>
