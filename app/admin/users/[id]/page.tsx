            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex gap-2 mt-3">
                <Link href={`/admin/tradies/${userId}`}
                  className="flex-1 text-center text-xs font-medium py-2 rounded-lg bg-[#EFF6FF] text-[#2563EB] hover:bg-[#DBEAFE] transition-colors">
                  View Documents →
                </Link>
                <Link href={`/admin/tradies/${userId}`}
                  className="flex-1 text-center text-xs font-medium py-2 rounded-lg bg-amber-50 text-amber-700 hover:bg-amber-100 transition-colors">
                  Edit Categories →
                </Link>
              </div>
            </div>
